...
class BaseUE(Agent):
    def __init__(self, ue_id: int, ue_settings: dict, sim_model=None):
        """
        Initialize the ue.
        """
        ...
        # Read the settings for the ue
        self.ue_data_rate = ue_settings['bytes_per_second']
    ...
    def get_data(self) -> DataUnitBase:
        """

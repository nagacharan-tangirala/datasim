...
class SimulationHelper:
    ...
    def read_simulation_and_model_settings(self) -> None:
        ...
        self.orchestrator_models_data[C_EDGE_ORCHESTRATOR] = self.config_data[C_EDGE_ORCHESTRATOR]
        self.orchestrator_models_data[C_CLOUD_ORCHESTRATOR] = self.config_data[C_CLOUD_ORCHESTRATOR]
    ...
    def create_loggers(self) -> None:
        ...
        if C_LOGGING_LEVEL in self.config_data[C_SIMULATION_SETTINGS]:
            logging_level = str(self.config_data[C_SIMULATION_SETTINGS][C_LOGGING_LEVEL]).upper()
    ...
    def create_file_readers(self) -> None:
        ...
        self._create_new_file_reader(input_files[CC_VEHICLE_TRACE_FILE],
        ...
        self._create_new_file_reader(input_files[CC_BASE_STATIONS_FILE],
    ...
    def _create_new_file_reader(self,
        ...
        if file_type == CC_PARQUET:
            self.file_readers[file_key] = ParquetDataReader(file_path, column_names, column_dtypes)
